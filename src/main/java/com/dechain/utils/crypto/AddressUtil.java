...
import com.dechain.utils.exception.AddressFormatException;
...
public class AddressUtil {
    ...
    public static String createNewAddressSecp256k1(String mainPrefix, byte[] publickKey) throws Exception {
        ...
        try {
            ...
            addressResult = com.dechain.utils.crypto.encode.Bech32.encode(mainPrefix, bytes);
        } catch (Exception e) {
    ...
    public static String getPubkeyBech32FromValue(String mainPrefix, byte[] publickKeyValue) throws Exception {
        try {
            ...
            String pubBech32 = com.dechain.utils.crypto.encode.Bech32.encode(mainPrefix, bytes);
            return pubBech32;
        } catch (Exception e) {
            throw new RuntimeException(e);
        }
    ...
    public static String convertAddressFromValToBech32(String valAddress){
        ...
        try {
            ...
            bech32Address = com.dechain.utils.crypto.encode.Bech32.encode(EnvInstance.getEnv().GetMainPrefix(), bytes);
        } catch (Exception e) {
            throw new RuntimeException(e);
        }
        return bech32Address;
    ...
    public static String convertAddressFromBech32ToVal(String bech32Address){
        ...
        try {
            ...
            valAddress = com.dechain.utils.crypto.encode.Bech32.encode(EnvInstance.getEnv().GetValidatorAddrPrefix(), bytes);
        } catch (Exception e) {
            throw new RuntimeException(e);
        }
        return valAddress;
