...
public class AccountFace {
    ...
    public static void main(String[] args) {
      ...
      //  System.out.println(pri);
        ...
        System.out.println(
                AccountFace.
                        importByMnemonic("legal news head orange never seek clip position exclude umbrella lobster note midnight manual silent cube leopard sort excess mixture winter raccoon cliff vast"));
        System.out.println(AccountFace.addressToHex("de1gxlsgvsaeclvyyufylte0ptu6ev22qx4jnensw"));
