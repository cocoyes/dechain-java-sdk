...
public class EthAddress {
    ...
    public static void TestcreateNewAddressSecp256k1() throws Exception {
        ...
        String addr = AddressUtil.createNewAddressSecp256k1("dechain", Hex.decode(key.getPubKey()));
        System.out.println("address is : " + addr);
    }

    public static void TestConvertAddress() throws Exception {
        String ethAddr = AddressUtil.convertAddressFromBech32ToHex("dechain1w739u0j5gngjlh5v2w7fnnj9tf2vu44m3qy6xy");
